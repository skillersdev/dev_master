...
$msg="";
//validation starts
// if userid is less than 4 char then status is not ok
if(!isset($username) or strlen($username) <4){
$msg=$msg."User Id Should Contain Minimum 4 CHARACTERS.<BR>";
$status= "NOTOK";}					
...
<section id="content" >
  <div class="container aside-xl"> <a class="navbar-brand block" href="#">Register in Roodabatoz </a>
  <div class="row">
                <div class="col-sm-18">
                  <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"], ENT_QUOTES, "utf-8"); ?>" method="post" data-validate="parsley">
                    <section class="panel panel-default">
                      ...
                      <div class="panel-body">
						...
						<div class="col-sm-6">
                          <label>Phone</label>
                          <input type="text" class="form-control" data-type="phone" placeholder="(XXX) XXXX XXX"  name="mobile" >
                        </div>
						</div>
...
/* code by karthikeyan ends */?>
						...
						<label>Package</label>
                            <select data-required="true" class="form-control m-t" name="package" required>
                                <option value="">Please choose</option>
								<?php /* code by karthikeyan starts */
								if (isset($_SESSION['aff']) && isset($_SESSION['pack'])){
									$query="SELECT id,name,price,currency,tax FROM packages where id != '3' AND active='1'";
								}
								else{
									$query="SELECT id,name,price,currency,tax FROM packages where id = '3' AND active='1'";
								}
...
<?php /* code here was cut off and added above by karthikeyan */ ?>
			<div class="form-group">
			...
			echo $_SESSION['aff']; } ?>" required>                        
                        ...
                        <!--<div class="checkbox i-checks">
                          <label>
                            <input type="checkbox" name="check" ><i></i> I agree to the <a href="#" class="text-info">Terms of Service</a>
                          </label>
                        </div>-->
                      </div>
